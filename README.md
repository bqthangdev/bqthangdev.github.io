...
| **Settings** | Quản lý theme Dark/Light, ẩn/hiện Sidebar, và cài đặt `localStorage` của tool (Markdown Reader: view mode, Sync scroll, Focus, Memory); nút reset về mặc định |
...
- Tab **Settings** quản lý theme, sidebar và cài đặt tool; Memory dùng nút On/Off; Clear saved content làm mờ khi Memory Off
